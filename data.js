  ...
  nations: {
    ...
    se: {
      ...
      rows: [
        ...
        [
          ...
          { name: "Gustaf Lagerbielke", pos: "CB", club: "Braga" },
          { name: "Victor Lindelöf", pos: "CB", club: "Aston Villa" },
          { name: "Daniel Svensson", pos: "RB", club: "Borussia Dortmund" },
        ],
        [
          { name: "Elliot Stroud", pos: "LM", club: "Mjällby AIF" },
          { name: "Yasin Ayari", pos: "CM", club: "Brighton & Hove Albion" },
          { name: "Lucas Bergvall", pos: "CM", club: "Tottenham Hotspur" },
    ...
    de: {
      ...
      rows: [
        ...
        [
          { name: "Nathaniel Brown", pos: "LB", club: "Bayern Munich" },
          { name: "Antonio Rüdiger", pos: "CB", club: "Real Madrid" },
          { name: "Jonathan Tah", pos: "CB", club: "Bayern Munich" },
          { name: "Joshua Kimmich", pos: "RB", club: "Bayern Munich" },
        ],
        [
          { name: "Felix Nmecha", pos: "CM", club: "Borussia Dortmund" },
          { name: "Aleksandar Pavlović", pos: "CM", club: "Bayern Munich" },
        ],
        [
          { name: "Florian Wirtz", pos: "LW", club: "Liverpool" },
          { name: "Kai Havertz", pos: "AM", club: "Arsenal" },
          { name: "Leroy Sané", pos: "RW", club: "Galatasaray" },
        ],
    ...
    eg: {
      ...
      formation: "4-2-3-1",
      rows: [
        [{ name: "Mostafa Shoubir", pos: "GK", club: "Al Ahly" }],
        [
          { name: "Karim Hafez", pos: "LB", club: "Pyramids FC" },
          { name: "Yasser Ibrahim", pos: "CB", club: "Al Ahly" },
          { name: "Ramy Rabia", pos: "CB", club: "Al Ain" },
          { name: "Mohamed Hany", pos: "RB", club: "Al Ahly" },
        ],
        [
          { name: "Marawan Attia", pos: "DM", club: "Al Ahly" },
          { name: "Mohanad Lashin", pos: "CM", club: "Pyramids FC" },
        ],
        [
          { name: "Mostafa Zico", pos: "LW", club: "Pyramids FC" },
          { name: "Emam Ashour", pos: "AM", club: "Al Ahly" },
          { name: "Mohamed Salah", pos: "RW", club: "Free agent" },
        ],
        [{ name: "Haissem Hassan", pos: "ST", club: "Real Oviedo" }],
      ],
    },
    ec: {
      name: "Ecuador",
    ...
    ci: {
      ...
      rows: [
        ...
        [
          { name: "Ghislain Konan", pos: "LB", club: "Gil Vicente" },
          { name: "Odilon Kossounou", pos: "CB", club: "Atalanta" },
          { name: "Emmanuel Agbadou", pos: "CB", club: "Beşiktaş" },
          { name: "Guela Doué", pos: "RB", club: "Strasbourg" },
        ],
        [
          { name: "Franck Kessié", pos: "CM", club: "Al-Ahli" },
          { name: "Ibrahim Sangaré", pos: "DM", club: "Nottingham Forest" },
          { name: "Christ Inao Oulaï", pos: "CM", club: "Trabzonspor" },
        ],
        [
          { name: "Yan Diomande", pos: "LW", club: "RB Leipzig" },
          { name: "Ange-Yoan Bonny", pos: "ST", club: "Inter Milan" },
          { name: "Nicolas Pépé", pos: "RW", club: "Villarreal" },
        ],
      ],
    },
    dk: {
    ...
    "gb-sct": {
      ...
      formation: "4-2-3-1",
      rows: [
        [{ name: "Angus Gunn", pos: "GK", club: "San Jose Earthquakes" }],
        [
          { name: "Andy Robertson", pos: "LB", club: "Liverpool" },
          { name: "Grant Hanley", pos: "CB", club: "Hibernian" },
          { name: "Jack Hendry", pos: "CB", club: "Al-Ettifaq" },
          { name: "Aaron Hickey", pos: "RB", club: "Brentford" },
        ],
        [
          { name: "Scott McTominay", pos: "CM", club: "Napoli" },
          { name: "Lewis Ferguson", pos: "CM", club: "Bologna" },
        ],
        [
          { name: "Lawrence Shankland", pos: "LW", club: "Rangers" },
          { name: "John McGinn", pos: "AM", club: "Aston Villa" },
          { name: "Ben Doak", pos: "RW", club: "Bournemouth" },
        ],
    ...
    mx: {
      ...
      rows: [
        ...
        [
          ...
          { name: "Jorge Sánchez", pos: "RB", club: "PAOK" },
        ],
        [
          { name: "Érik Lira", pos: "CM", club: "Cruz Azul" },
          { name: "Luis Romo", pos: "DM", club: "Guadalajara" },
          { name: "Gilberto Mora", pos: "CM", club: "Tijuana" },
        ],
        [
          { name: "Roberto Alvarado", pos: "LW", club: "Guadalajara" },
          { name: "Raúl Jiménez", pos: "ST", club: "Wolves" },
          { name: "Julián Quiñones", pos: "RW", club: "Al-Qadsiah" },
        ],
      ],
    },
    sn: {
      ...
      rows: [
        ...
        [
          ...
          { name: "Pathé Ciss", pos: "CB", club: "Rayo Vallecano" },
          { name: "Moussa Niakhaté", pos: "CB", club: "Lyon" },
          { name: "Krépin Diatta", pos: "RB", club: "Free agent" },
        ],
        [
          { name: "Pape Gueye", pos: "CM", club: "Villarreal" },
          { name: "Idrissa Gueye", pos: "DM", club: "Everton" },
          { name: "Habib Diarra", pos: "CM", club: "Sunderland" },
        ],
        [
          { name: "Sadio Mané", pos: "LW", club: "Al-Nassr" },
          { name: "Ismaïla Sarr", pos: "ST", club: "Crystal Palace" },
          { name: "Iliman Ndiaye", pos: "RW", club: "Everton" },
        ],
      ],
    },
  },
